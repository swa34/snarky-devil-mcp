...
import {
  ...
  INTENSITY_MODIFIERS,
} from "./prompts/snarky.js";
import type { Intensity } from "./tools/cold_take.js";

// confidence values the model can return
...
export function _setClient(mock: Anthropic): void {
  client = mock;
}
 ...
 */
export async function callSnarkyAPI(
  userMessage: string,
  intensity?: Intensity
): Promise<SnarkyResponse> {
